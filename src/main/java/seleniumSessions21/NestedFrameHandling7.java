...
//3.
public class NestedFrameHandling7 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.switchTo().parentFrame();//If parent is Main Page then it will switch to the Main Page.
		//String header=driver.findElement(By.tagName("h3")).getText();
		//System.out.println(header);
		
		//switching from frame1 to Main Page can be done as follows:
