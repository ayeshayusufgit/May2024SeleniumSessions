...
public class FluentWaitConcept2 {
	...
	public static void main(String[] args) {
		...
		By firstName = By.id("Form_getForm_Name111");//making the id wrong
		...
		//This will wait for 10 secs after which it will throw the TimeOutException
		//along with a custom message only if the element is not visible on the webpage							
	}
}
