...
//Is it really mandatory to write @BeforeSuite @BeforeTest @BeforeClass and @AfterSuite @AfterTest @AfterClass
//On commenting out @BeforeSuite, @BeforeTest will start running first.

public class TestNGFeatures2 {
	
	//1
//	@BeforeSuite	//Suppose there is no database
